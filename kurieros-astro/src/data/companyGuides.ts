...
const COMPANY_GUIDES: Readonly<Record<string, CompanyGuide>> = {
  'kuper-ex-sbermarket': {
    ...
    summary:
      'Купер работает с доставкой продуктов и заказов из магазинов. На КурьерОк эта страница нужна не как второй каталог вакансий, а как справочник по работодателю: здесь собраны условия, частые вопросы и переход к основному списку вакансий.',
    primaryHubHref: '/rabota-kurerom-kuper/',
    primaryHubLabel: 'Смотреть все вакансии Купер',
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'Для выбора вакансии лучше открывать основной хаб Купера на КурьерОк: там собраны карточки по городам, ролям, транспорту и доходу. Эта страница помогает понять условия работодателя до отклика.',
      },
    ],
    sourceNotes: [
