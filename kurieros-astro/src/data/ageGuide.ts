...
export const AGE_GUIDE = {
  ...
  rows: [
    ...
    },
    {
      ...
      role: 'Представитель',
      roleId: 'bank',
      minimumAge: 'Формальный минимум не указан; младше 18 предлагают курсы и стажировки',
      parentalConsent: 'Не указано',
  ...
  roleSections: [
    ...
    {
      id: 'bank',
      heading: 'Банковский представитель: возраст указан не в каждой вакансии',
      body:
        'Т-Банк кандидатам младше 18 лет предлагает образовательные курсы и стажировки, но формальный минимум обычной вакансии на проверенной справочной странице не публикует. Представители оформляются по ГПД, а в части объявлений — как самозанятые. В проверенной вакансии Альфа-Банка опубликовано оформление по ТК РФ, но возраст и согласие родителей не названы. Неизвестные поля нельзя заполнять по аналогии с другим банком.',
      sourceIds: [
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer:
        'Т-Банк на вопрос кандидатов младше 18 лет отвечает предложением курсов и стажировок, но формальный минимум вакансии представителя не публикует. Альфа-Банк в проверенной вакансии возраст также не указал.',
