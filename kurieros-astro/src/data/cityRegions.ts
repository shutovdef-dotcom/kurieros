...
const CITY_REGIONS: Readonly<Record<string, string>> = {
  ...
  'Соржа-Рыжики': 'Ленинградская область',
  Тельмана: 'Ленинградская область',
  Алнаши: 'Удмуртская Республика',
  Вавож: 'Удмуртская Республика',
  Придорожный: 'Самарская область',
  'с.п. Большелогское': 'Ростовская область',
  'х Ленина': 'Ростовская область',
  'х Хомуты': 'Республика Адыгея',
  ...
  'деревня Островцы': 'Московская область',
  'рабочий посёлок Лопатино': 'Московская область',
};
