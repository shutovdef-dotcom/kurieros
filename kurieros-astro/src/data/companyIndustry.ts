...
export const COMPANY_INDUSTRY: Readonly<Record<string, string>> = {
  ...
  'X5 Доставка': 'Курьерская доставка',
  'Еда в Яндекс Go': 'Курьерская доставка',
  'Еда в Yandex Go': 'Курьерская доставка',
  Voxys: 'Контакт-центр и клиентский сервис',
  Qlean: 'Клининг и бытовые услуги',
  'Сервис «Руки»': 'Ремонт и бытовые услуги',
  Домовёнок: 'Клининг и бытовые услуги',
  Тетрика: 'Образование и онлайн-обучение',
};
