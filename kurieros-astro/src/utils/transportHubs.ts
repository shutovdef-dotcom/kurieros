...
export const HUB_CONFIGS: Readonly<Record<TransportHubKey, HubConfig>> = {
  ...
  flexible: {
    ...
    incomeBlurb:
      'Подработка курьером с гибким графиком: выбирайте смены под свой распорядок — ' +
      'от коротких слотов до вечерних или ночных смен. Выплаты зависят от компании: ' +
      'еженедельно, ежедневно или по графику работодателя.',
    requirementsBullets: [
